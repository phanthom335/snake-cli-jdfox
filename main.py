    ...
    Snake Cli Jdfox
    ===============
    Open-source Python game project showcasing how to challenge classic mechanics.
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source Python game project showcasing how to challenge classic mechanics.")
